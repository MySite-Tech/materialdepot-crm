...
| [`partner-bridge.md`](partner-bridge.md) | The Outreach→KAM handoff PRD against this repo, and the link to the partner dashboard. **P1 built 2026-09-21** (provisioning, the link roster, power users); P2–P4 still design | 191 |
