import { B2BLeadRow, MetaSpec, arr, str } from '../data/rows';
import { Escalation } from '@/components/b2b/models/account-health';
import { ClientContact, ClientEntity, ClientEntityType, ClientGst, ClientInteraction, ClientMergeRecord, ClientSource, KamAssignment, normalizeContactNumber, normalizeGst } from '@/components/b2b/models/client';
