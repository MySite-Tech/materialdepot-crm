...
import { selectionsFromKylasLabels } from '@/components/b2b/models/inboundModel';
...
export function mapInboundLead(raw: Record<string, any>): import('../../../components/b2b/models/mockData').InboundLead {
