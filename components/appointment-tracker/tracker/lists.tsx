...
import { SLOTS, VALUE_TONE } from '../constants/appointments';
...
import { customerName, inRange, link3d, phoneOf, rangeLabel, requirement, slotIndexFor, timeOnly } from '../utils/appointments';
