...
import { DateChipProps, FilterChipProps } from '../types/footfall';
import { fmtDate } from '../utils/footfall';
import { useState } from 'react';

export function FilterChip({ label, options, selected, onChange, color, searchable }: FilterChipProps) {
