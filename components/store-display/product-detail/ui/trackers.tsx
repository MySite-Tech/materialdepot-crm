...
import { cancelMovement, completeMovement } from '../../../../lib/store-display/display-api';
import { CHANGE_STEPS, REMOVAL_STEPS } from '../constants';
import { ChangeLocationRequest, ChangeStatus, RemovalReason, RemovalStatus } from '../types';
import { StepLadder } from '.';
