...
export { OWNER_LABEL, OWNER_CHIP, INBOUND_STATUSES, INBOUND_STATUS_COLORS, INBOUND_STATUS_HINT, INBOUND_NURTURE_STATUS, INBOUND_FOLLOW_UP_STATUSES, INBOUND_OPEN_STATUSES, isFollowUpStatus, isOpenStatus, SEGMENTS, LEAD_TYPES, LEAD_TYPE_COLORS, PRIORITY_COLORS, SELECTIONS, PLACED_UNDER_FIELDS, PLACED_UNDER_TITLE, PLACED_UNDER_SUBTITLE, FOLLOW_UP_LABEL, FOLLOW_UP_COLORS } from '../../constants/inbound';
