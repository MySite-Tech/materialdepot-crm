...
import { ClientEntity, ClientInteraction, INTERACTION_TYPES, InteractionType, TEMPERATURE_BANDS, TEMPERATURE_MAX, clampTemperature, contactLabel, currentTemperature, primaryContact, temperatureColor } from '../../models/clientModel';
import { CadenceRow, interactionGateErrors, interactionPrompts, queueAgeBand } from '../../models/kamModel';
