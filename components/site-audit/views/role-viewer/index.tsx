...
import { CITIES, activeStaffFilter, encodePerson, loadCityFilter, saveCityFilter, sbGet, type CityFilter } from '../../shared';
import SiteAuditorApp from '../../apps/auditor';
import SiteInstallerApp from '../../apps/installer';
import SiteAuditJobsView from '../jobs';
import SiteAuditPerfView from '../perf';
import SiteAuditAnalyticsView from '../analytics';
import SiteAuditInstallOpsView from '../install-ops';
import SiteAuditOpsView from '../ops';
import SiteShadowerApp from '../../apps/site-shadower-app';
import SiteAuditBmView from '../bm';
import SiteAuditCoeView from '../coe';
import SiteAuditBranchManagerView from '../branch-manager';

const SiteAuditLiveView = dynamic(() => import('../live'), { ssr: false });
