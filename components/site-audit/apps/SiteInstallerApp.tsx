...
import {
  ...
  ArrivalCameraModal,
  DocScannerModal,
} from '@/components/site-audit/apps/fieldAppShared';
import {
  CATEGORY_LIST,
  MD_CATEGORIES,
  categoryFor,
  ...
  typeLabel,
  type FieldValues,
} from '@/components/site-audit/data/auditRegistry';
import { AuditRoomCard } from '@/components/site-audit/ui/AuditRoomViews';
import {
  MD_INK,
  MD_MUTED,
  loadBrandLogo,
