...
import { GROUP_LABEL_CLS } from '../constants';
import { Segment } from '../../types/auditor';
import { fieldValue } from '../utils';
import { DocScannerModal } from '@/components/site-audit/apps/field-app-shared';
import { AdjustRow, CategoryDef, FieldValues, PrereqEntry, fieldsFor, unitFor } from '@/components/site-audit/data/audit-registry';
