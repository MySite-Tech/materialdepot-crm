...
import { renderSketchData } from '../utils/pdf';
...
import { blankSegment } from '../utils';
import { SketchCanvas } from '@/components/site-audit/apps/field-app-shared';
import { CATEGORY_LIST, ROOM_V, adjRows, categoryFor, needsVariant, prereqFlagged, segmentPrereqRows, segmentRows, unitFor, unitNoteFor } from '@/components/site-audit/data/audit-registry';
