...
import { MD_INK, MD_MUTED, loadBrandLogo, mdBrandGrid, mdInfoTable, mdPdfAuditRoom, mdPdfConsent, mdPdfHeader, mdPdfInstallRoom } from '@/components/site-audit/brand/pdfBrand';
import { categoryFor, mdInstallTermsBlock } from '@/components/site-audit/data/auditRegistry';
