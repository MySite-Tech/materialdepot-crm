...
import { CITIES, ROLES, crmPermissionsForSiteAuditRole, initials, phoneKey, sbPatch, sbPost } from '../../siteAuditShared';
import { INSTALLER_TYPES, PAY_FIELDS, ROLE_OPTIONS } from '../../constants/staff-users';
import { ProfileRow } from '../../types/staff-users';
import { Field, Foot, Modal, RoleBadge } from './ui';
import { inputCls, isInstallerRole } from '../../utils/staff-users';
import { addUser } from '@/lib/mockApi';
